...
typedef size_t (*kai_matmul_clamp_f16_qai8dxp_qsi4cxp_get_lhs_packed_offset_func_t)(size_t m_idx, size_t k);
typedef size_t (*kai_matmul_clamp_f16_qai8dxp_qsi4cxp_get_rhs_packed_offset_func_t)(size_t n_idx, size_t k);
typedef size_t (*kai_matmul_clamp_f16_qai8dxp_qsi4cxp_get_dst_offset_func_t)(
    size_t m_idx, size_t n_idx, size_t dst_stride);
typedef size_t (*kai_matmul_clamp_f16_qai8dxp_qsi4cxp_get_dst_size_func_t)(size_t m, size_t n);
...
struct kai_matmul_clamp_f16_qai8dxp_qsi4cxp_ukernel {
    ...
    kai_matmul_clamp_f16_qai8dxp_qsi4cxp_get_lhs_packed_offset_func_t get_lhs_packed_offset;
    kai_matmul_clamp_f16_qai8dxp_qsi4cxp_get_rhs_packed_offset_func_t get_rhs_packed_offset;
