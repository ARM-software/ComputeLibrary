...
/// -# @ref kai_rhs_pack_nxk_qsi4c32pscalef16_qsu4c32s16s0 to pack the RHS NxK matrix.
...
size_t kai_get_dst_size_matmul_clamp_f32_qsi8d32p1x8_qsi4c32p8x8_1x8_sve_dotprod(
    size_t m,   //
    size_t n);  //
...
/// @param[in]  lhs_packed     The LHS packed matrix. The micro-kernel to pack the native LHS matrix is reported at
///                            the top of this file.
/// @param[in]  rhs_packed     The RHS packed matrix. The micro-kernel to pack the native RHS matrix is reported at
///                            the top of this file.
