...
size_t kai_get_m_step_matmul_clamp_f32_qai8dxp1x8_qsi4c32p8x8_1x8_neon_dotprod(void);
...
///
/// @return the n step
size_t kai_get_n_step_matmul_clamp_f32_qai8dxp1x8_qsi4c32p8x8_1x8_neon_dotprod(void);

/// Gets the mr value, which must be used to pack the LHS matrix
///
/// @return the mr value
size_t kai_get_mr_matmul_clamp_f32_qai8dxp1x8_qsi4c32p8x8_1x8_neon_dotprod(void);

/// Gets the nr value, which must be used to pack the RHS matrix.
///
/// @return the nr value
size_t kai_get_nr_matmul_clamp_f32_qai8dxp1x8_qsi4c32p8x8_1x8_neon_dotprod(void);

/// Gets the kr value, which must be used to pack the LHS and RHS matrices
///
/// @return the kr value
size_t kai_get_kr_matmul_clamp_f32_qai8dxp1x8_qsi4c32p8x8_1x8_neon_dotprod(void);

/// Gets the sr value, which must be used to pack the LHS and RHS matrices
///
/// @return the sr value
size_t kai_get_sr_matmul_clamp_f32_qai8dxp1x8_qsi4c32p8x8_1x8_neon_dotprod(void);
...
size_t kai_get_lhs_packed_offset_matmul_clamp_f32_qai8dxp1x8_qsi4c32p8x8_1x8_neon_dotprod(
    size_t m_idx,  //
    size_t k);     //
...
size_t kai_get_rhs_packed_offset_matmul_clamp_f32_qai8dxp1x8_qsi4c32p8x8_1x8_neon_dotprod(
    size_t n_idx,  //
    size_t k,      //
    size_t bl);    //

/// Gets the offset in bytes for the destination matrix
///
/// @param[in] m_idx      Row index in the destination matrix. It must be 1.
/// @param[in] n_idx      Column index in the destination matrix. It must be multiple of n_step.
/// @param[in] dst_stride The number of bytes in each row of the destination matrix
///
/// @return the destination offset in bytes
size_t kai_get_dst_offset_matmul_clamp_f32_qai8dxp1x8_qsi4c32p8x8_1x8_neon_dotprod(
    size_t m_idx,        //
    size_t n_idx,        //
    size_t dst_stride);  //
...
///
/// @param[in] m Number of rows in the destination matrix.
/// @param[in] n Number of columns in the destination matrix.
///
/// @return the destination matrix size in bytes
size_t kai_get_dst_size_matmul_clamp_f32_qai8dxp1x8_qsi4c32p8x8_1x8_neon_dotprod(
    size_t m,   //
    size_t n);  //
...
/// @param[in]  dst_stride_row Stride in bytes between two rows of the destination matrix.
/// @param[in]  dst_stride_col Stride in bytes between two columns of the destination matrix. It must be sizeof(float)
/// bytes.
/// @param[in]  scalar_min     Min value used to clamp the final result.
/// @param[in]  scalar_max     Max value used to clamp the final result.
void kai_run_matmul_clamp_f32_qai8dxp1x8_qsi4c32p8x8_1x8_neon_dotprod(
    size_t m,                //
    size_t n,                //
    size_t k,                //
    size_t bl,               //
