...
/// @param[in] dst_stride The number of bytes in each row of the DST matrix
///
...
size_t kai_get_dst_size_matmul_clamp_f32_qai8dxp1vlx4_qsi4c32p4vlx4_1vlx4vl_sme2_mopa(size_t m, size_t n);
