...
///
///   * LHS: @ref kai_get_lhs_offset_lhs_pack_f32p2vlx1_f32_sme.
///   * Packed LHS: @ref kai_get_lhs_packed_offset_lhs_pack_f32p2vlx1_f32_sme.
///
/// @param[in] m Number of rows of the unpacked LHS matrix.
/// @param[in] k Number of columns in the unpacked LHS matrix.
/// @param[in] mr Block size in M dimension. It must be kai_get_m_step_lhs_pack_f32p2vlx1_f32_sme().
