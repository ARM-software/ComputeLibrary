...
void kai_kernel_rhs_pack_kxn_f32p16vlx1b_f32_f32_sme(const KernelArgs* args_ptr);
...
size_t kai_get_rhs_offset_rhs_pack_kxn_f32p16vlx1b_f32_f32_sme(size_t n_idx) {
    KAI_ASSUME(n_idx % kai_get_n_step_rhs_pack_kxn_f32p16vlx1b_f32_f32_sme() == 0);
...
size_t kai_get_rhs_packed_stride_rhs_pack_kxn_f32p16vlx1b_f32_f32_sme(size_t k) {
    return kai_get_n_step_rhs_pack_kxn_f32p16vlx1b_f32_f32_sme() *
...
size_t kai_get_rhs_packed_offset_rhs_pack_kxn_f32p16vlx1b_f32_f32_sme(size_t n_idx, size_t k) {
    ...
    return block_idx * kai_get_rhs_packed_stride_rhs_pack_kxn_f32p16vlx1b_f32_f32_sme(k);
}

size_t kai_get_rhs_packed_size_rhs_pack_kxn_f32p16vlx1b_f32_f32_sme(size_t n, size_t k) {
    const size_t n_nr_blocks = kai_roundup(n, kai_get_n_step_rhs_pack_kxn_f32p16vlx1b_f32_f32_sme());
    return kai_get_rhs_packed_offset_rhs_pack_kxn_f32p16vlx1b_f32_f32_sme(n_nr_blocks, k);
}
...
void kai_run_rhs_pack_kxn_f32p16vlx1b_f32_f32_sme(
    ...
    KAI_ASSUME(nr == kai_get_n_step_rhs_pack_kxn_f32p16vlx1b_f32_f32_sme());
    KAI_ASSUME(kr == KR);
    KAI_ASSUME(sr == 1);
    KAI_ASSUME(rhs != NULL);
    ...
    args.out_stride = kai_get_rhs_packed_stride_rhs_pack_kxn_f32p16vlx1b_f32_f32_sme(args.height);

    kai_commit_za();

    kai_kernel_rhs_pack_kxn_f32p16vlx1b_f32_f32_sme(&args);
}
