...
size_t kai_get_lhs_packed_offset_matmul_clamp_f32_qai8dxp1x4_qsi8cxp4vlx4_1x4vl_sme_dot(
    size_t m_idx,  //
    size_t k);     //
...
size_t kai_get_rhs_packed_offset_matmul_clamp_f32_qai8dxp1x4_qsi8cxp4vlx4_1x4vl_sme_dot(
    size_t n_idx,  //
    size_t k);     //
...
size_t kai_get_dst_size_matmul_clamp_f32_qai8dxp1x4_qsi8cxp4vlx4_1x4vl_sme_dot(
    size_t m,   //
    size_t n);  //
...
/// Output tile: (rows x cols) = 1 x 4vl
///
/// Features used: sme
///
