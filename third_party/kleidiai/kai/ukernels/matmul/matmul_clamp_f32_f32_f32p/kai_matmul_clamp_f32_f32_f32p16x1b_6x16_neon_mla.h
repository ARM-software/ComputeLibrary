...
size_t kai_get_m_step_matmul_clamp_f32_f32_f32p16x1b_6x16_neon_mla(void);
...
size_t kai_get_n_step_matmul_clamp_f32_f32_f32p16x1b_6x16_neon_mla(void);
...
///
/// @return The nr value.
size_t kai_get_nr_matmul_clamp_f32_f32_f32p16x1b_6x16_neon_mla(void);
...
///
/// @return The kr value.
size_t kai_get_kr_matmul_clamp_f32_f32_f32p16x1b_6x16_neon_mla(void);
...
///
/// @return The sr value.
size_t kai_get_sr_matmul_clamp_f32_f32_f32p16x1b_6x16_neon_mla(void);
...
size_t kai_get_lhs_offset_matmul_clamp_f32_f32_f32p16x1b_6x16_neon_mla(size_t m_idx, size_t stride);
...
///
/// @return The offset in bytes to the data element.
size_t kai_get_rhs_packed_offset_matmul_clamp_f32_f32_f32p16x1b_6x16_neon_mla(size_t n_idx, size_t k);
...
///
/// @return The offset in bytes to the data element.
size_t kai_get_dst_offset_matmul_clamp_f32_f32_f32p16x1b_6x16_neon_mla(size_t m_idx, size_t n_idx, size_t stride);
...
size_t kai_get_dst_size_matmul_clamp_f32_f32_f32p16x1b_6x16_neon_mla(size_t m, size_t n);
...
///
///   * LHS: @ref kai_get_lhs_offset_matmul_clamp_f32_f32_f32p16x1b_6x16_neon_mla.
///   * Packed RHS: @ref kai_get_rhs_packed_offset_matmul_clamp_f32_f32_f32p16x1b_6x16_neon_mla.
///   * Output: @ref kai_get_dst_offset_matmul_clamp_f32_f32_f32p16x1b_6x16_neon_mla.
///
...
/// values.
///
void kai_run_matmul_clamp_f32_f32_f32p16x1b_6x16_neon_mla(
