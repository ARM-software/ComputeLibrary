...
void kai_kernel_matmul_clamp_f32_f32_f32p16vlx1b_1x16vl_sme2_mla(KernelArgs* args_ptr);
...
static size_t kai_get_rhs_packed_stride_matmul_clamp_f32_f32_f32p16vlx1b_1x16vl_sme2_mla(size_t k) {
    return kai_get_n_step_matmul_clamp_f32_f32_f32p16vlx1b_1x16vl_sme2_mla() *
...
size_t kai_get_rhs_packed_offset_matmul_clamp_f32_f32_f32p16vlx1b_1x16vl_sme2_mla(size_t n_idx, size_t k) {
    ...
    const size_t block_idx = n_idx / kai_get_n_step_matmul_clamp_f32_f32_f32p16vlx1b_1x16vl_sme2_mla();
    return block_idx * kai_get_rhs_packed_stride_matmul_clamp_f32_f32_f32p16vlx1b_1x16vl_sme2_mla(k);
}
...
void kai_run_matmul_clamp_f32_f32_f32p16vlx1b_1x16vl_sme2_mla(
    ...
    kai_kernel_matmul_clamp_f32_f32_f32p16vlx1b_1x16vl_sme2_mla(&args);
}
