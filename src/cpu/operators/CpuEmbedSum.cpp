...
void CpuEmbedSum::run(ITensorPack &tensors)
{
    ...
    std::cout << "token->info()->valid_strides_in_bytes()[0] " <<token->info()->strides_in_bytes()[0] <<std::endl; 
    std::cout << "token->info()->valid_strides_in_bytes()[1] " <<token->info()->strides_in_bytes()[1] <<std::endl; 
    std::cout << "token->info()->valid_strides_in_bytes()[2] " <<token->info()->strides_in_bytes()[2] <<std::endl; 

    std::cout << "output->info()->valid_strides_in_bytes()[0] " <<output->info()->strides_in_bytes()[0] <<std::endl; 
    std::cout << "output->info()->valid_strides_in_bytes()[1] " <<output->info()->strides_in_bytes()[1] <<std::endl; 
    std::cout << "output->info()->valid_strides_in_bytes()[2] " <<output->info()->strides_in_bytes()[2] <<std::endl; 
