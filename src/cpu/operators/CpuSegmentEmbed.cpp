...
namespace cpu
{
void CpuSegmentEmbed::configure(const ITensorInfo *input, const ITensorInfo *segment,  ITensorInfo *output)
{
...
Status
CpuSegmentEmbed::validate(const ITensorInfo *input, const ITensorInfo *segment, const ITensorInfo *output)
{
